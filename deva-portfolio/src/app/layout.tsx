...
export const metadata: Metadata = {
  title: "Devadhatthan L",
  description: "Devadhatthan L's portfolio",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <title>Devadhatthan L</title>
        <meta name="description" content="Devadhatthan L's portfolio" />

        {/* Facebook Meta Tags */}
        <meta property='og:url' content='https://thanhlongnguyen.vercel.app/' />
        <meta property='og:type' content='website' />
        <meta property='og:title' content='Devadhatthan L' />
        <meta property='og:description' content="Devadhatthan L's portfolio" />
        ...
        <meta name="twitter:title" content="Devadhatthan L" />
        <meta name="twitter:description" content="Devadhatthan L's portfolio" />
